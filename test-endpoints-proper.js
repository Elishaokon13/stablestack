...
/**
 * Proper API Endpoint Testing Script
 * Uses valid MongoDB ObjectIds and proper test data
 */
...
// Test categories with proper data
const tests = {
  // 1. Authentication & User Management
  auth: [
    {
      name: 'GET /api/user/profile (by clerkId)',
      method: 'GET',
      endpoint: `/api/user/profile?clerkId=${TEST_DATA.clerkId}`,
    },
    {
...
async function runTests() {
  console.log('🚀 Starting Proper API Endpoint Testing');
  console.log(`📍 Base URL: ${BASE_URL}`);
  console.log(`🆔 Test User ID: ${TEST_DATA.userId}`);
  console.log('=' * 50);
